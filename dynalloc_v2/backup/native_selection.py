...
def native_select_factor_suite(
    *,
    ...
    manifest = {
        ...
        'selection_score_mode': 'stage1_mean_first_spec_protocol_then_stage2_global_real_ppgdpo' if diagnostic_units else 'stage1_mean_first_spec_protocol_only',
        ...
        'stage2_model_variants': [spec.label for spec in stage2_model_specs],
            ...
            'score_mode': (
                'stage2 protocol+covariance selection: ce_est + 1.0*gain_vs_zero, with gain_vs_myopic kept for reporting only and final winners chosen by global rerank across all stage2 models from stage1 survivors'
