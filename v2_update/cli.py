...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_native.add_argument('--selection-eval-mode', choices=['projection', 'pure_qp', 'foc_clip'], default='pure_qp')
    ...
    p_native.add_argument('--pipinn-policy-output-mode', choices=['projection', 'pure_qp', 'foc_clip'], default='pure_qp')
